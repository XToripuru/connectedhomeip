...
def run_test(obj, test, apps_register, paths, pics_file, test_timeout_seconds):
...
if __name__ == "__main__":
    ...
    result = run_test(obj["context"], obj["test"], apps_register, obj["paths"], obj["pics_file"], obj["test_timeout_seconds"])
